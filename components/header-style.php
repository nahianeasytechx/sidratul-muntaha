...
*********************************/
	...
	.search_input {
		...
		padding-left: 20px;
		background: transparent;
		border-bottom: solid 2px #06ec79;
		color: #FFFFFF;
	}
...
*********************************/
	...
	.owl-carousel .owl-item img {
		display: block;
		width: 100%;
		border-radius: 30px 31px 0px 0px;
		-webkit-border-radius: 30px 31px 0px 0px;
	...
	.donate_card_bg .card-btn button {
		width: 75%;
...
.notice-features h1{
   ...
   color: #008E48;
	...
	.course-description-subtext {
		padding: 20px;
		margin: auto 0;

	}

	.course-description-subtext h4 {
		font-size: 16px;
		font-weight: 600;

	}

	.course-description-subtext p {
		font-size: 14px;
